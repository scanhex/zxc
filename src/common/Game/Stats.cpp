...
void Stats::changeDamage(int32_t delta) {
    damage_ += delta;
}
void Stats::changeAttackRange(double delta) {
    attackRange_ += delta;
}
void Stats::changeMoveSpeed(int32_t delta) {
    moveSpeed_ += delta;
}
void Stats::changeTurnRate(int32_t delta) {
    turnRate_ += delta;
}
void Stats::changeAttackSpeed(int32_t delta) {
    attackSpeed_ += delta;
}
...
void Stats::changeHPRegen(double delta) {
    hpRegen_ += delta;
}
void Stats::changeMPRegen(double delta) {
    mpRegen_ += delta;
}
void Stats::changeArmor(int32_t delta) {
    armor_ += delta;
}
void Stats::changeResist(double delta) {
    resist_ += delta;
}
...
int32_t Stats::getDamage() const {
    return damage_;
}
void Stats::setDamage(int32_t damage) {
    damage_ = damage;
}  // forbid negative applyDamage?

int32_t Stats::getDefaultDamage() const {
    return default_damage_;
}
void Stats::setDefaultDamage(int32_t damage) {
    default_damage_ = damage;
}

double Stats::getAttackRange() const {
    return attackRange_;
}
void Stats::setAttackRange(double attackRange) {
    attackRange_ = attackRange;
}

uint32_t Stats::getMoveSpeed() const {
    return moveSpeed_;
}
void Stats::setMoveSpeed(uint32_t moveSpeed) {
    moveSpeed_ = moveSpeed;
}

double Stats::getTurnRate() const {
    return turnRate_;
}
void Stats::setTurnRate(double turnRate) {
    turnRate_ = turnRate;
}

uint32_t Stats::getAttackSpeed() const {
    return attackSpeed_;
}
void Stats::setAttackSpeed(uint32_t attackSpeed) {
    attackSpeed_ = attackSpeed;
}

uint32_t Stats::getMaxHp() const {
    return maxHP_;
}
...
double Stats::getHealthPoints() const {
...
double Stats::getManaPoints() const {
    return manaPoints_;
}
...
double Stats::getHpRegen() const {
    return hpRegen_;
}
void Stats::setHpRegen(double hpRegen) {
    hpRegen_ = hpRegen;
}

double Stats::getMpRegen() const {
    return mpRegen_;
}
void Stats::setMpRegen(double mpRegen) {
    mpRegen_ = mpRegen;
}

int32_t Stats::getArmor() const {
    return armor_;
}
void Stats::setArmor(int32_t armor) {
    armor_ = armor;
}

double Stats::getResist() const {
    return resist_;
}
